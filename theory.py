...
def find_best_fit_mle( model, x_data, y_data, 
                   bounds, 
                   initial_guess, 
    ...
    print( f"Kernel here is : {kernel}, type {type(kernel)}" )
    ...
    optimal_parameters, log_likelyhood = calculate_MLE( model, 
                   initial_guess, x_data, y_data, initial_guess, bounds, 
                   logarithmic = True,
                   kernel = kernel,
                   alpha_gp = alpha_gp, 
    ...
    return optimal_parameters, log_likelyhood, onset_parameters
...
def calculate_MLE( model, param, x_data, y_data, initial_guess, bounds, logarithmic = True,
  ...
  print( f"Kernel inside MLE is : {kernel}, type {type(kernel)}" )
  ...
  mle_log_likelyhood = neg_log_likelihood( estimated_parameter )

  print( f"Estimated Parameters: {estimated_parameters}, best log likelyhood = {mle_log_likelyhood}" )

  return estimated_parameter, mle_log_likelyhood
